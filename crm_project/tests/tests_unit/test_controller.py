...
class TestCommercialController(BaseTest):
    ...
    def test_update_customer(self):
        ...
        updated_data =  {
            'name': 'Jean dupont update',
            'email': 'jean.update@contact.com',
            'company_name': 'Update event corp'
        }
        updated_customer = self.controller.update_customer(customer_name, **updated_data)

        self.assertIsNotNone(updated_customer)
        self.assertEqual(updated_customer.name, updated_data['name'])
...
class TestManagementController(BaseTest):
    ...
    def setUp(self):
        ...
        self.management_controller = ManagementController(self.session, self.user)


    def test_create_contract(self):
        new_contract = self.management_controller.create_contract(self.customer, **self.contract_data)
    ...
    def test_update_contract(self):
        ...
        updated_contract = self.controller.update_contract(self.customer.name, new_contract.id, **updated_data)
